...
# UCOP Organizations (in handlers/ucop/ directory)
UCOP_ORGANIZATIONS = {
    "handlers/ucop/academic_affairs": {
    ...
    "handlers/ucop/ethics_compliance_audit_services": {
    ...
    "handlers/ucop/external_relations_communications": {
    ...
    "handlers/ucop/uc_national_laboratories": {
    ...
    "handlers/ucop/university_of_california_health": {
    ...
    "handlers/ucop/systemwide_office_of_civil_rights": {
