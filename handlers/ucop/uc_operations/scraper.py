"""
Scraper for UC Operations organization.
"""
...
class UCOperationsScraper(BaseScraper):
    """Scraper for UC Operations."""

    def __init__(self):
        org_config = ORGANIZATIONS['handlers/ucop/uc_operations']
        super().__init__(
            org_name=org_config['name'],
            org_dir='handlers/ucop/uc_operations',
