"""
Scraper for UC Investments organization.
"""
...
class UCInvestmentsScraper(BaseScraper):
    """Scraper for UC Investments."""

    def __init__(self):
        org_config = ORGANIZATIONS['handlers/ucop/uc_investments']
        super().__init__(
            org_name=org_config['name'],
            org_dir='handlers/ucop/uc_investments',
