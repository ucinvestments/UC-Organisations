"""
Scraper for UC Legal - Office of the General Counsel organization.
"""
...
class UCLegalScraper(BaseScraper):
    """Scraper for UC Legal."""

    def __init__(self):
        org_config = ORGANIZATIONS['handlers/ucop/uc_legal']
        super().__init__(
            org_name=org_config['name'],
            org_dir='handlers/ucop/uc_legal',
