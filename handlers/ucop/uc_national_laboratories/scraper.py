"""
Scraper for UC National Laboratories organization.
"""
...
class UCNationalLabsScraper(BaseScraper):
    """Scraper for UC National Laboratories."""

    def __init__(self):
        org_config = ORGANIZATIONS['handlers/ucop/uc_national_laboratories']
        super().__init__(
            org_name=org_config['name'],
            org_dir='handlers/ucop/uc_national_laboratories',
