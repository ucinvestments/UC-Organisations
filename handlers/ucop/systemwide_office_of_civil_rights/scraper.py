"""
Scraper for Systemwide Office of Civil Rights organization.
"""
...
class CivilRightsOfficeScraper(BaseScraper):
    """Scraper for Systemwide Office of Civil Rights."""

    def __init__(self):
        org_config = ORGANIZATIONS['handlers/ucop/systemwide_office_of_civil_rights']
        super().__init__(
            org_name=org_config['name'],
            org_dir='handlers/ucop/systemwide_office_of_civil_rights',
    ...
    def scrape_staff(self):
        ...
        for department, url in self.staff_urls.items():
            ...
            for staff in staff_members:
                self.save_staff_member(staff, 'immediate_office')
...
if __name__ == '__main__':
    scraper = CivilRightsOfficeScraper()
    scraper.run()
