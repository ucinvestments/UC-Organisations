"""
Scraper for UC Finance organization.
"""
...
class UCFinanceScraper(BaseScraper):
    """Scraper for UC Finance."""

    def __init__(self):
        org_config = ORGANIZATIONS['handlers/ucop/uc_finance']
        super().__init__(
            org_name=org_config['name'],
            org_dir='handlers/ucop/uc_finance',
