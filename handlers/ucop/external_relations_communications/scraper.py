"""
Scraper for External Relations and Communications organization.
"""
...
class ExternalRelationsCommsScraper(BaseScraper):
    """Scraper for External Relations and Communications."""

    def __init__(self):
        org_config = ORGANIZATIONS['handlers/ucop/external_relations_communications']
        super().__init__(
            org_name=org_config['name'],
            org_dir='handlers/ucop/external_relations_communications',
    ...
    def scrape_staff(self):
        ...
        for department, url in self.staff_urls.items():
            ...
            for staff in staff_members:
                self.save_staff_member(staff, department if department != 'main' else 'immediate_office')
...
if __name__ == '__main__':
    scraper = ExternalRelationsCommsScraper()
    scraper.run()
