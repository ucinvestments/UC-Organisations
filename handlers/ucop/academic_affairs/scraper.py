"""
Scraper for Academic Affairs organization.
"""
...
class AcademicAffairsScraper(BaseScraper):
    """Scraper for Academic Affairs."""

    def __init__(self):
        org_config = ORGANIZATIONS['handlers/ucop/academic_affairs']
        super().__init__(
            org_name=org_config['name'],
            org_dir='handlers/ucop/academic_affairs',
    ...
    def extract_staff_from_page(self, soup, department):
        ...
        for heading in headings:
            ...
            # Extract contact info from siblings
...
if __name__ == '__main__':
    scraper = AcademicAffairsScraper()
    scraper.run()
